...
```bash
docker run -it --rm -p 15002:15002 apache/spark:4.1.1 bash -c "/opt/spark/sbin/start-connect-server.sh --wait"
```
...
Apache Spark 4 supports [SQL Pipe Syntax](https://spark.apache.org/docs/4.1.1/sql-pipe-syntax.html).
