...
```bash
docker run -it --rm -p 15002:15002 apache/spark:4.2.0 bash -c "/opt/spark/sbin/start-connect-server.sh --wait"
```
...
Connected to Apache Spark 4.2.0 Server
...
Apache Spark 4 supports [SQL Pipe Syntax](https://spark.apache.org/docs/4.2.0/sql-pipe-syntax.html).
