...
```bash
docker run --rm -p 15002:15002 apache/spark:4.2.0 bash -c "/opt/spark/sbin/start-connect-server.sh --wait -c spark.log.level=ERROR"
```
...
apache/spark-connect-swift:stream   fd07cc72bb59        112MB           32MB
```
