...
def main():
    ...
    parser.add_argument("-v", "--version", help="Version to use (e.g. connect-swift-1.0.0)")
    ...
    jira_id = create_jira_issue(asf_jira, args.title, "Connect", args.parent, args.type, args.version)
