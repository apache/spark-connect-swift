...
GITHUB_BASE = "https://github.com/apache/spark-connect-swift/pull"
GITHUB_API_BASE = "https://api.github.com/repos/apache/spark-connect-swift"
...
def initialize_jira():
    ...
    if not JIRA_IMPORTED:
        ...
        client = jira.client.JIRA(jira_server, token_auth=JIRA_ACCESS_TOKEN, timeout=(3.05, 60))
        try:
        ...
        asf_jira = jira.client.JIRA(jira_server, basic_auth=(JIRA_USERNAME, JIRA_PASSWORD), timeout=(3.05, 60))
    else:
